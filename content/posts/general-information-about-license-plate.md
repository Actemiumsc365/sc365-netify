---
title: General Information About License Plate
---
TABLE OF CONTENTS
...
Order: we use it for any sales or purchase order in the business central (Quote, return order, order, etc.)
Parent: we use a parent License Plate above other License plates in the hierarchy.
Child: we use child license plates inside parent license plates in the hierarchy.
Mutation: we use mutation to put stock on a license plate, you must do this with a mutation order. click here to see the tutorial. 
SupplyChain365 License Plate States
Status
